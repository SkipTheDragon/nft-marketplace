...
class BlockchainCrudController extends AbstractCrudController
{
    ...
    public function configureFields(string $pageName): iterable
    {
        return [
            ...
            TextField::new('name'),
            ChoiceField::new('type')->setChoices(EBlockchainType::cases()),
            UrlField::new('rpc'),
            NumberField::new('chainId'),
            TextField::new('nativeToken'),
            AssociationField::new('nfts', 'NFTs')->hideOnForm()->setDisabled()->formatValue(function ($value, $entity) {
